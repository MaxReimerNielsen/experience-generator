...
var fs = require('fs');
const CONFIG_PATH = `/api`;
const RESOURCE_PATH_CAMPAIGNS = `${CONFIG_PATH}/-/Campaigns`;
const RESOURCE_PATH_DASHBOARD = `${CONFIG_PATH}/-/Dashboard`;
...
module.exports = ( PORT ) => {
  ...
  apiServer.get(RESOURCE_PATH_OVERVIEW, function (req, res) {
    var output = {
    Data : {
  ...
  apiServer.get(RESOURCE_PATH_OUTCOMES, function (req, res) {
  ...
  apiServer.get(RESOURCE_PATH_LANDINGPAGES, function (req, res) {
    res.send(JSON.stringify({  
      Data:{    
  ...
  apiServer.get( RESOURCE_PATH_DASHBOARD, function ( req, res ) {
    var output = {
       Data:{ 
          chartsData: {
            visitsPerChannel: [
  ...
  apiServer.get( RESOURCE_PATH_CAMPAIGNS, function ( req, res ) {
    var output = {
      Data:{ 
        traffic: {
